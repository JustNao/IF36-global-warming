...
Afin de pouvoir comparer encore mieux la température avec la surface de la banquise nous avons crée deux graphiques interactifs sur Shiny pour avoir un visuel au bonnes echelles de l'évolution de ces deux paramètres en fonction des années. (Voir Shiny - Pôle Nord)
